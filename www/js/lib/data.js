/**
* Modulo de Datos de Configuracion global
*/
            ...
            },
            {
                ...
                data: [
                    {id: 1, 
                     ...
                     imglarge: 'images/bg01-large-1366x900.png'},
                    {id: 2, 
                     imgsmall: 'images/bg02-small-320x480.png', 
                     imglarge: 'images/bg02-large-1366x900.png'},
                    {id: 3, 
                     imgsmall: 'images/bg03-small-320x480.png', 
                     imglarge: 'images/bg03-large-1366x900.png'},
                    {id: 4, 
                     imgsmall: 'images/bg04-small-320x480.png', 
                     imglarge: 'images/bg04-large-1366x900.png'},
                    {id: 5, 
                     imgsmall: 'images/bg05-small-320x480.png', 
                     imglarge: 'images/bg05-large-1366x900.png'},
                    {id: 6, 
                     imgsmall: 'images/bg06-small-320x480.png', 
                     imglarge: 'images/bg06-large-1366x900.png'}
                 ]
            }
        ],
        indexedDb: {
